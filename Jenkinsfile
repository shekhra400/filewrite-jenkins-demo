    ...
    stage('Deploy CloudHub') {
      ...
      steps {
		...
		*/
		...
		bat 'C://Users//shekshukla//AppData//Roaming//npm//anypoint-cli --username="shekshukla" --password="Kansas@12345" runtime-mgr cloudhub-application deploy --environment="Test" --runtime "$(RUNTIME)" --workers "$WORKERS" --workerSize "0.1" --region "us-east-1" "asas" "target/filewrite-jenkins-demo-1.0.0-mule-application.jar"'
