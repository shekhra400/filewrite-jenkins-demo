pipeline {
  ...
  stages {
    ...
    stage('Deploy Nexus') {
      steps {
        nexusArtifactUploader artifacts: [[artifactId: "filewrite-jenkins-demo", classifier: "", file: "workspace/Filewrite_Jenkins_Pipeline/target/filewrite-jenkins-demo-1.0.0-mule-application.jar", type: "jar"]], credentialsId: "Nexusrepo", groupId: "in.mywebapp", nexusUrl: "localhost:9091", nexusVersion: "nexus2", protocol: "http", repository: "file-write-jenkins-demo", version: "1.0.0"
      }
    }
